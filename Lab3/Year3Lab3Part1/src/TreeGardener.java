...
public class TreeGardener extends Frame
implements ActionListener {
   // private Checkbox Veggie, Annual, Peren;
	private Checkbox trees;
    ...
    private void setGUI() {
        ...
        left.add(new Label("Trees"));
         CheckboxGroup grp= new CheckboxGroup();
         trees = new Checkbox("trees", grp, false);
       ...
       // left.add(Peren);
        ...
        trees.addItemListener(new TreeListener());

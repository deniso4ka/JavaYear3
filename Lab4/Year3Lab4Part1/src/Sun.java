...
public class Sun extends CelestialBody {
	...
	private static Sun sun; //adding the static instance of sun
	 ...
	 */
											//adding and returning only one instace of sun
	public static Sun createSun(String name, SolarSystem system) throws SolarSystemSunLimitException {
		  if(sun==null) { //If no Sun has been created, allow Sun Singleton creation
		    ...
		    return sun; //Return instance of Sun
			   ...
			   //If the Singleton pattern is exceeded, i.e., more than allowed objects created
				    throw new SolarSystemSunLimitException("This Solar System can only have 1 Sun");//trow an exeption if more then one creating
